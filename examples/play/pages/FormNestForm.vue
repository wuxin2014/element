<template>
  <el-form ref="formData" :model="formData" :rules="formRule" label-width="100px">
    ...
    <el-form-item
      ...
      :rules="{required: true, message: 'model不能为空', trigger: 'blur'}">
      <el-input v-model="phone.model"></el-input>
      <el-form
        :model="formData.phones[index]" 
        label-width="100px"
      >
        <el-form-item
          ...
          label="data1" 
          :rules="{required: true, message: 'data1不能为空', trigger: 'blur'}">
